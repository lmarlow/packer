...
type FlatConfig struct {
	...
	USBScanCode               *bool             `mapstructure:"usb_scan_codes" cty:"usb_scan_codes" hcl:"usb_scan_codes"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"usb_scan_codes":                 &hcldec.AttrSpec{Name: "usb_scan_codes", Type: cty.Bool, Required: false},
